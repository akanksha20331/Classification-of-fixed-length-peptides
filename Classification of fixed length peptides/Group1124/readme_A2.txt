Assignment 2 BDMH
Fixed length peptide classification
Name:- Aman Srivastava (MT20333)
       Akanksha jarwal (MT20331)
       Prabhat Singh (MT20341) 

Problem Statement:-
To develop models for predicting class of peptides. There are total 8 class of peptides with labels A, B, C, D, E, F, G, H.
...
Model :-
Standard Scalar:
Used for remiving the means and scalling the unit variance.
GridSearchCV:
...
The model is trained with GridSearchCV, batch_size of 128 and was able to achieve a loss of (0.52837) with (56.83%) accuracy for validation data.
